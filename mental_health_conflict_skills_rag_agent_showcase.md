# Bullying + CBT + Conflict Skills RAG Agent (Google Colab)
...
## Why I built it
- To showcase end-to-end LLM + Retrieval-Augmented Generation (RAG) skills in Colab.
- To produce helpful, practical, evidence-based guidance for common real-life conflict situations.
...
## Limitations
- The build can take time if I ingest too many documents in one run.
